...
import DashboardNoRegistration from "./DashboardNoRegistration"
...
const handlePayment = async () => {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      throw new Error(`Failed to create PhonePe order: ${errorText}`);
    }
    ...
    // Optionally store both IDs if needed later
